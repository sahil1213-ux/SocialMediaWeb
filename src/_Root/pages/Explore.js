...
const Explore = () => {
    ...
    return (_jsxs("div", { className: "explore-container", children: [_jsxs("div", { className: "explore-inner_container", children: [_jsx("h2", { className: "h3-bold md:h2-bold w-full", children: "Search Posts/Captions" }), _jsxs("div", { className: "flex gap-1 px-4 w-full rounded-lg bg-dark-4", children: [_jsx("img", { src: "/assets/icons/search.svg", width: 24, height: 24, alt: "search" }), _jsx(Input, { type: "text", placeholder: "Search/ min 3 characters", className: "explore-search", value: searchValue, onChange: (e) => {
